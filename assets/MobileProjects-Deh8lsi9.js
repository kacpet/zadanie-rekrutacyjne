import{t as e}from"./index-D7IMctAU.js";import{t}from"./react-CM63EY2z.js";import{n,t as r}from"./arrow-DP-qFJ4U.js";var i=e(),a={hidden:{},visible:{}},o={hidden:{opacity:0,x:-40},visible:{opacity:1,x:0,transition:{duration:1.1,ease:`easeOut`}}},s={hidden:{clipPath:`inset(0 0 100% 0)`},visible:{clipPath:`inset(0 0 0% 0)`,transition:{duration:1.3,ease:[.76,0,.24,1]}}},c={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.7,delay:1,ease:`easeOut`}}};function l(){return(0,i.jsx)(`div`,{id:`projects`,className:`\r
        ...
        bg-[#DCC1AB]\r
        pt-30\r
      `,children:(0,i.jsxs)(t.div,{variants:a,initial:`hidden`,whileInView:`visible`,viewport:{once:!0,amount:.05,margin:`0px 0px -150px 0px`},className:`flex min-h-screen flex-col`,children:[(0,i.jsxs)(t.h2,{variants:o,className:`\r
            mb-10\r
            px-6\r
            text-3xl\r
            font-medium\r
